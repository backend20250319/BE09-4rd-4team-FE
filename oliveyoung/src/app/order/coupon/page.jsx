...
export default function Coupon() {
  ...
  const handleDownloadCoupon = async (coupon) => {
    ...
    const fetchCouponDownload = async () => {
      try {
        await axios.post("http://localhost:8080/api/user/coupons",
        {
          couponId: coupon.id,
        },
        {
              ...
              <div
                ...
                style={{
                  backgroundImage: issued
                    ...
                    : coupon.name.toLowerCase().includes("summer15") ? `url('/images/order/coupon/bg_coupon_today_325.png')` : `url('/images/order/coupon/bg_coupon_325.png')`,
                }}
              >
