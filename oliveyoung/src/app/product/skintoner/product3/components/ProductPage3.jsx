...
const ProductDescription = () => {
  const descriptionImages = [
        ...
        "/images/product/detailpage24.jpg",
        "/images/product/detailpage25.jpg",
        "/images/product/detailpage26.jpg",
        "/images/product/detailpage27.jpg",
      ...
      {visibleImages.map((imagePath, index) => (
        <div
          ...
          className={`w-full max-w-[800px] ${
            !isDescriptionExpanded && index === 1 ? "overflow-hidden h-[1900px]" : "h-auto mb-2"
...
function ProductPage3() {
  const thumbnailPaths = [
    "/images/product/thumbnail8.jpg",
    "/images/product/thumbnail9.jpg",
    "/images/product/thumbnail10.jpg",
    "/images/product/thumbnail11.jpg",
    "/images/product/thumbnail13.jpg",
  ];

  const [mainImage, setMainImage] = useState(
    thumbnailPaths && thumbnailPaths.length > 0
      ? thumbnailPaths[0]
      : "/images/product/skintoner18.jpg"
  );
    ...
    <div className="relative max-w-6xl mx-auto font-sans bg-white">
      ...
      <div className="flex items-center px-4 py-3 pb-2 mb-6 text-sm text-gray-400 border-b md:px-0">
        ...
        <span className="text-black ">
          [수딩진정] 넘버즈인 1번 진정 맑게담은 청초토너 300ml 기획 (+1번 패드
          10매 증정)
        </span>
      </div>
      {/* 메인 상품 콘텐츠 */}
      <div className="flex flex-col gap-12 p-4 md:flex-row md:p-0">
        ...
        <div className="flex flex-col lg:w-3/5">
          <div className="relative w-full max-w-[500px] h-[500px] mb-8">
            ...
            <img
              src={mainImage}
              alt="[수딩진정] 넘버즈인 1번 진정 맑게담은 청초토너 300ml 기획 (+1번 패드 10매 증정)"
        ...
        <div className="p-4 md:w-1/2 lg:w-3/5 md:p-0">
          ...
          <p className="text-sm text-gray-600">
            ...
            {/* 눈 모양 아이콘으로 변경 */}
            <span className="font-extrabold text-[#f27370]">8</span>
          ...
          <div className="flex items-center justify-between py-4 mb-6 border-b-2 border-[#e02020]">
            ...
            {/* 폰트 굵기 제거 */}
            <span className="text-xl font-bold text-red-500">16,980원</span>
            {/* 색상 강조 */}
          </div>
      ...
      <div className="flex items-center justify-between px-4 py-4 mt-4 border-t border-gray-200 md:px-0">
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            ...
            <span className="text-gray-500">(6,805건)</span>
          </div>
        </div>
