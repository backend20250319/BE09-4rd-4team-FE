...
//     "product/detailpage1.jpg",
//     "product/detailpage2.jpg",
//     "product/detailpage3.jpg",
//     "product/detailpage4.jpg",
//     "product/detailpage5.jpg",
//     "product/detailpage13.jpg",
//     "product/detailpage6.gif",
//     "product/detailpage14.jpg",
//     "product/detailpage7.jpg",
//     "product/detailpage8.jpg",
//     "product/detailpage9.gif",
//     "product/detailpage10.jpg",
//     "product/detailpage11.jpg",
//     "product/detailpage12.jpg",
//   ];
...
//         <img
//           key={index}
//           src={getImageUrl(imagePath)} // ✅ 풀 URL로 변환
...
//                   mainImage === getImageUrl(imagePath) // ✅ 비교도 풀 URL로!
//                     ? "border-2 border-black"
//                     : "border border-gray-300"
//                 } hover:border-black`}
//                 onClick={() => handleThumbnailClick(imagePath)} // ✅ 그대로 두세요 (함수 안에서 getImageUrl 해주니까)
//               >
//                 <a href="#" onClick={(e) => e.preventDefault()}>
//                   <img
//                     src={getImageUrl(imagePath)} // ✅ 여기만 바꿔주면 됨!
//                     alt={`썸네일 이미지 ${index + 1}`}
...
//                   <div className="flex-shrink-0 w-24 h-24 mr-3">
//                     <img
//                       src={getImageUrl(product.img)} // ✅ 여기!
//                       alt={product.name}
//                       className="object-contain w-full h-full rounded-md"
//                     />
//                   </div>
