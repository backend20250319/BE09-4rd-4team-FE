        ...
        setTimeout(() => {
          ...
          if (name === "박창준" && birth === "000000" && phone === "00000000") {
            resolve({
              ok: true,
              json: () =>
                Promise.resolve({ isMember: true, userName: "박*준" }),
            });
          } else {
            resolve({
              ok: true,
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-white">
      ...
      <div className="max-w-4xl w-full mx-auto py-10 px-4 md:px-8">
        <h1 className="text-center text-4xl md:text-5xl font-cj mb-6 mt-8">
          회원가입
        </h1>{" "}
        {/* 폰트 크기 조정 */}
          ...
          <>
            ...
            <section className="mb-8 border p-4 rounded bg-gray-50">
              ...
              <ul className="text-sm text-gray-700 space-y-2 list-disc pl-5">
                ...
                {/* 리스트 스타일 추가 */}
                <li>
                  기존 회원가입 정보와 일치하는 정보를 입력해야 회원가입 여부를
                  정확하게 확인할 수 있습니다.
                </li>
                <li>
                  올리브영, CJ더마켓, CJ온스타일, CJ문화재단 등에서는
                  전자상거래에 의거하여 만 14세 미만의 어린이/학생의 회원가입을
                  제한합니다.
                </li>
                <li>
                  외국인 회원가입 시에는 국내에서 발급된 외국인 등록증/신분증
                  정보를 입력해주세요.
                </li>
              </ul>
            </section>
