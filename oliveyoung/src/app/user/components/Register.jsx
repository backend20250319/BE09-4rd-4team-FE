...
const RegistrationForm = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.phonePart2.trim() || !formData.phonePart3.trim()) newErrors.phone = '휴대폰 번호를 입력해주세요.';
        if (!formData.emailLocal.trim() || !formData.emailDomain.trim()) newErrors.email = '이메일을 입력해주세요.';
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) { // 유효성 검사 통과 시
            ...
            try {
                ...
                if (response.ok) { // 응답이 성공적일 경우 (HTTP 상태 코드 200-299)
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col items-center">
            ...
            <div className="w-full bg-white shadow-sm py-4 px-6 flex justify-between items-center">
                <div className="flex items-center space-x-4">
                    <img src="https://www.cjone.com/cjmweb/images/common/logo_cjone.png" alt="CJ ONE 로고" className="h-6" />
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <img src="https://www.cjone.com/cjmweb/images/common/logo_oliveyoung.png" alt="올리브영 로고" className="h-6" />
                </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-4xl my-8">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-8 border-t pt-6">
                        ...
                        {/* 아이디 입력 필드 */}
                        <div className="grid grid-cols-3 gap-4 mb-4 items-center">
                            <label htmlFor="id" className="text-gray-700 font-medium flex items-center">
                            ...
                            <div className="col-span-2 flex space-x-2">
                                ...
                                />
                                <button type="button" className="bg-gray-700 text-white px-4 py-2 rounded-md text-sm whitespace-nowrap hover:bg-gray-800 transition-colors">
                                    중복확인
                                </button>
                            </div>
                            {errors.id && <p className="text-red-500 text-xs col-start-2 col-span-2 mt-1">{errors.id}</p>}
                            <div className="col-start-2 col-span-2 text-sm text-gray-600 mt-1">
                                <p>CJ ONE 아이디는 6~12자 이내 영문 소문자, 숫자 조합으로 입력해주세요. (특수문자 및 공백 제외)</p>
                                <p>CJ ONE 통합 아이디로 가입하시면 CJ ONE 홈페이지, 앱, 제휴 브랜드에서 편리하게 이용하실 수 있습니다.</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4 items-center">
                            ...
                            <div className="col-span-2">
                                ...
                                <div className="text-sm text-gray-600 mt-1">
                                    <p>영문 대문자, 영문 소문자, 숫자, 특수문자 중 3가지 이상을 조합하여 10~16자를 입력해주세요.</p>
                                    <p>생년월일, 전화번호 등 개인정보와 관련된 숫자, 동일 숫자 3자리 이상 반복, 동일 문자 4자리 이상 반복은 사용 불가능합니다.</p>
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4 items-center">
                            ...
                            {errors.phone && <p className="text-red-500 text-xs col-start-2 col-span-2 mt-1">{errors.phone}</p>}
                            <div className="col-start-2 col-span-2 text-sm text-gray-600 mt-1">
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4 items-center">
                            ...
                            {errors.email && <p className="text-red-500 text-xs col-start-2 col-span-2 mt-1">{errors.email}</p>}
                            <div className="col-start-2 col-span-2 text-sm text-gray-600 mt-1">
                ...
                <div className="mt-12 text-gray-600 text-sm border-t pt-6">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li>CJ ONE 회원이 되시면 CJ ONE 웹사이트에서 풍부한 정보와 서비스를 이용하실 수 있습니다.</li>
                        <li>개인정보 수집 및 활용 동의에 자세한 내용은 <a href="#" className="text-blue-600 hover:underline">개인정보처리방침</a>을 확인하실 수 있습니다.</li>
                    </ul>
                </div>
            </div>
