      ...
      <div className="float-left w-[850px] min-h-[640px] px-[29px] pb-[40px] bg-[#fff]">
        ...
        <ul className="overflow-hidden w-full h-[80px] py-[20px] bg-white rounded-[5px] border border-[#696969]">
          <li className="overflow-hidden float-left w-1/2 px-[20px]">
            ...
            <Link href="/order/coupon" onClick={e => handleMenuClick(e, href)} className="float-right w-[130px] h-[30px] mt-[5px] pt-[6px] pl-[13px] rounded-[4px] bg-[#ebebeb] bg-[url('/images/mypage/coupon/arrow_12_21_02.png')] bg-no-repeat bg-[length:7px_11px] bg-[position:113px_50%] text-[#202020] text-left text-[14px] leading-[20px]">쿠폰 존 바로가기</Link>
          </li>
          <li className="overflow-hidden float-left w-1/2 px-[20px] border-l border-[#d6d6d6]">
            <p className="float-left text-[#3e3e3e] text-[14px] leading-[20px]">
              보유하고 계시는<br />쿠폰번호를 등록하세요.
            </p>
            <Link href="" className="float-right w-[130px] h-[30px] mt-[5px] pt-[6px] pl-[13px] rounded-[4px] bg-[#ebebeb] bg-[url('/images/mypage/coupon/arrow_12_21_02.png')] bg-no-repeat bg-[length:7px_11px] bg-[position:113px_50%] text-[#202020] text-left text-[14px] leading-[20px]">쿠폰 등록하기</Link>
          </li>
        </ul>

        <div className="block">
          <div className="overflow-hidden relative w-full">
            <button type="button" className="float-right w-auto my-[18px] mb-[6px] pr-[19px] bg-[url('/images/mypage/coupon/ico_coupon14x14.png')] bg-no-repeat bg-[position:99%_50%] text-[#888] text-[12px] leading-[18px] text-center font-medium cursor-pointer">쿠폰안내</button>
          </div>
        </div>
        ...
        <table className="table-fixed w-full border-t-[2px] border-t-[#d6d6d6] border-b border-b-[#e6e6e6]">
          ...
          <thead>
            <tr>
              <th className="pt-[11px] pb-[10px] bg-[#fafafa] text-[#666] text-[14px] leading-[18px]">혜택</th>
              <th className="pt-[11px] pb-[10px] bg-[#fafafa] text-[#666] text-[14px] leading-[18px]">쿠폰명</th>
              <th className="pt-[11px] pb-[10px] bg-[#fafafa] text-[#666] text-[14px] leading-[18px]">쿠폰사용조건</th>
