    ...
    <div>
      ...
      <div className="float-left w-[850px] px-[29px] pb-[40px]">
        ...
        <fieldset className="mt-[20px] overflow-hidden relative w-full mt-[20px] mb-0 pt-[20px] pr-[20px] pb-[20px] pl-[20px] bg-[#fafafa] box-border rounded-[5px]">
          <div className="mb-[14px]">
            ...
            <ul className="flex">
              <li className="float-left w-auto h-[28px]">
                <button type="button" className="w-full h-[28px] px-[15px] border border-[#555555] rounded-[5px] bg-[#555555] text-white text-[12px] font-normal text-center shadow-none cursor-pointer">온라인몰 구매</button>
              </li>
              <li className="float-left w-auto h-[28px] ml-[4px]">
                <button type="button" className="w-full h-[28px] px-[15px] border border-[#e5e5e5] rounded-[5px] bg-white text-[#222222] text-[12px] font-normal text-center shadow-none cursor-pointer">매장 구매</button>
              </li>
            </ul>
          </div>

          <div className="mb-[14px] block clear-both overflow-hidden">
            <p className="float-left mr-[20px] text-[#666666] text-[12px] font-bold leading-[30px] tracking-[-0.48px]">구매기간</p>
            <ul className="overflow-hidden">
              {[1, 3, 6, 12].map((months) => (
                <li key={months} className={`float-left w-auto h-[28px]${months !== 1 ? ' ml-[4px]' : ''}`}>
                  <button
                    type="button"
            ...
            <div className="float-left pt-[10px] leading-[38px]">
              ...
              <label className="inline-block m-0 mx-[11px] ml-[1px] text-[#222222] text-[12px] leading-[16px] cursor-pointer">년</label>
              ...
              <label className="inline-block m-0 mx-[11px] ml-[1px] text-[#222222] text-[12px] leading-[16px] cursor-pointer">월</label>
              ...
              <label className="inline-block m-0 mx-[11px] ml-[1px] text-[#222222] text-[12px] leading-[16px] cursor-pointer">일</label>
          ...
          onClick={handleSearch}>조회</button>
        </fieldset>
        ...
        <table className="table-fixed w-full border-t-[2px] border-b border-t-[#d6d6d6] border-b-[#e6e6e6] mt-[20px]">
          ...
          <thead>
            <tr>
              <th scope="col" className="pt-[11px] pb-[10px] px-0 bg-[#fafafa] text-[#666666] text-[14px] leading-[18px]">주문일자</th>
              <th scope="col" className="pt-[11px] pb-[10px] px-0 bg-[#fafafa] text-[#666666] text-[14px] leading-[18px]">상품</th>
              <th scope="col" className="pt-[11px] pb-[10px] px-0 bg-[#fafafa] text-[#666666] text-[14px] leading-[18px]">수량</th>
              <th scope="col" className="pt-[11px] pb-[10px] px-0 bg-[#fafafa] text-[#666666] text-[14px] leading-[18px]">주문금액</th>
              <th scope="col" className="pt-[11px] pb-[10px] px-0 bg-[#fafafa] text-[#666666] text-[14px] leading-[18px]">상태</th>
            </tr>
          </thead>
          {filteredOrders.length === 0 ? (
            <tbody>
              <tr>
                <td colSpan={5} className="!w-full !pt-[200px] !px-[15px] !pb-[80px] !text-[#888888] !text-[16px] !text-center !leading-[20px] bg-[url('/images/mypage/order/ico_nodata104x104.png')] bg-no-repeat" 
                style={{backgroundPosition: "center 80px"}}>기간 내 주문내역이 없습니다</td>
              </tr>
            </tbody>
          ) : (
