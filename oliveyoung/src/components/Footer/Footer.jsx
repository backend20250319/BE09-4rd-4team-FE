      ...
      >
        <div className="w-[1020px] py-[18px] flex flex-row justify-between items-center">
          <ul className="flex flex-row text-xs text-[#000]">
            <li className="px-[10px] pr-[20px] border-r whitespace-nowrap">회사소개</li>
            <li className="px-[10px] border-r whitespace-nowrap">채용안내</li>
            <li className="px-[10px] border-r whitespace-nowrap">가맹점 개설문의</li>
            <li className="px-[10px] border-r whitespace-nowrap">상품입점 및 제휴문의</li>
            <li className="px-[10px] border-r whitespace-nowrap">사이버 감사실</li>
            <li className="px-[10px] whitespace-nowrap">고객센터</li>
          </ul>
          <select
