...
"[project]/src/components/NewProductModal.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": ()=>NewProductModal
});
...
;
;
function NewProductModal(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewProductModal.useEffect": ()=>{
            const fetchBrands = {
                "NewProductModal.useEffect.fetchBrands": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/admin/products");
            ...
            }["NewProductModal.useEffect.fetchBrands"];
            fetchBrands();
        }
    }["NewProductModal.useEffect"], []);
    const handleSubmit = (e)=>{
        ...
        onAdd({
            ...
            category,
            stock: Number(stock),
            price: "₩ ".concat(price.replace(/[^0-9]/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, ',')),
            status,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                            ...
                            children: [
                                ...
                                brandList.map((brand)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: brand.id,
                                        children: brand.name
                                    }, brand.id, false, {
                                        fileName: "[project]/src/components/NewProductModal.jsx",
...
_s(NewProductModal, "6eciVt+B6aTqlsyINLRphVxuWdA=");
_c = NewProductModal;
var _c;
...
"[project]/src/app/admin/constants/imageBase.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const BASE_IMAGE_URL = "http://dev.macacolabs.site:8008/images/4/";
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/admin/utils/image.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$constants$2f$imageBase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/constants/imageBase.ts [app-client] (ecmascript)");
;
const getImageUrl = (path)=>"".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$constants$2f$imageBase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BASE_IMAGE_URL"]).concat(path);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NewProductModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/NewProductModal.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$utils$2f$image$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/admin/utils/image.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function ProductsPage() {
                ...
                "ProductsPage.useEffect.fetchProducts": async ()=>{
                    try {
                        ...
                        const mappedData = data.map({
                            "ProductsPage.useEffect.fetchProducts.mappedData": (p)=>({
                                    id: p.productId,
                                    imageUrl: p.imageUrl,
                                    name: p.productName,
                                    brand: p.brandName,
                                    ...
                                    stock: p.stock,
                                    price: "₩ ".concat(p.discountedPrice.toLocaleString()),
                                    status: p.stock === 0 ? '품절' : p.stock <= 10 ? '품절임박' : '판매중',
                                    createdAt: p.createdAt
                                })
                        }["ProductsPage.useEffect.fetchProducts.mappedData"]);
    ...
    const handleAddProduct = async (newProduct)=>{
        try {
            ...
            const mappedData = data.map((p)=>({
                    ...
                    category: p.categoryName,
                    stock: p.stock,
                    price: "W ".concat(p.discountedPrice.toLocaleString()),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        className: "text-xs font-light tracking-wider text-left text-gray-500 uppercase bg-gray-50",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                className: "items-center text-[12px] px-[40px]",
                                                children: "상품이미지"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/admin/products/page.jsx",
                                                lineNumber: 204,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    className: "divide-y divide-gray-200  text-sm font-normal",
                                    children: paginatedProducts.map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            className: "whitespace-nowrap",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-6 py-4",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "w-24 h-16 flex items-center justify-center bg-white rounded overflow-hidden border border-gray-200",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                            src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$admin$2f$utils$2f$image$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(product.imageUrl),
                                                            alt: "상품",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-xs font-normal inline-block px-2 py-1 rounded-full whitespace-nowrap ".concat(product.status === '판매중' ? 'bg-green-100 text-green-700' : product.status === '품절임박' ? 'bg-yellow-100 text-yellow-700' : 'bg-red-100 text-red-700'),
            ...
            showModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NewProductModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(ProductsPage, "KZn6ZN+1CYurlzb9h8yg9vwMzEo=");
_c = ProductsPage;
var _c;
...
//# sourceMappingURL=src_4722bb31._.js.map